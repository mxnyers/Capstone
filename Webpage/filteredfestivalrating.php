...
<div class="search_by">
    ...
    if ($_POST['search'] == "one"){
        ...
        $sql = "Select * from Festival where Rating >= 1 ";
        ...
        $sql = "Select * from Festival where Rating >= 2 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
        ...
        $sql = "Select * from Festival where Rating >= 3 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
        ...
        $sql = "Select * from Festival where Rating >= 4 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
        ...
        $sql = "Select * from Festival where Rating >= 5 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
