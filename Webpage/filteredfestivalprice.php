...
<div class="search_by">
    ...
    if ($_POST['search'] == "one"){
        ...
        $sql = "Select * from Festival where Price < 100 ";
    ...
    else if ($_POST['search'] == "two"){
        $search = mysqli_real_escape_string($conn,$_POST['search']);
        $finalsearch = strtoupper($search);

        $sql = "Select * from Festival where Price >= 100 and Price < 200 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
    ...
    else if ($_POST['search'] == "three"){
        $search = mysqli_real_escape_string($conn,$_POST['search']);
        $finalsearch = strtoupper($search);

        $sql = "Select * from Festival where Price >= 200 and Price < 300 ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
    ...
    else if ($_POST['search'] == "four"){
        $search = mysqli_real_escape_string($conn,$_POST['search']);
        $finalsearch = strtoupper($search);

        $sql = "Select * from Festival where Price >= 300 and Price < 400  ";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
    ...
    else if ($_POST['search'] == "five"){
        $search = mysqli_real_escape_string($conn,$_POST['search']);
        $finalsearch = strtoupper($search);

        $sql = "Select * from Festival where Price >= 400";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];
