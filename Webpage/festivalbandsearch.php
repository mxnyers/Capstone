...
<div class="search_by">
    ...
    if (isset($_POST['search'])){
        ...
        $sql = "Select f.Festivalname, f.Startdate, f.EndDate, f.City, f.State from Festival as f, Bandinfestival as bf, Band as b where Bandname like '%$search%' and f.Festivalid = bf.Festivalid and bf.Bandid = b.Bandid";
        $result = mysqli_query($conn,$sql);
        $queryresults = mysqli_num_rows($result);
        $bandname = $_POST['search'];

        echo "It appears " .$bandname. " is playing at ".$queryresults." festivals in the Midwest sometime soon!";
